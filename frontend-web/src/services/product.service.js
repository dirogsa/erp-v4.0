...
// Infinite cache for search/catalogue in prod (invalidated via webhook), 0 in dev
const SEARCH_CACHE_OPTS = { next: { tags: ['products'], revalidate: process.env.NODE_ENV === 'development' ? 0 : 31536000 } };
