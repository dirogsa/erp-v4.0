  ...
  return (
    <div className="w-full mb-6 md:mb-0">
      ...
      <form onSubmit={handleSubmit} className="bg-[#141518] border border-white/5 rounded-2xl md:rounded-3xl p-4 md:p-6 shadow-xl" role="search">
        ...
        {activeTab !== 'DIMENSIONS' && (
          <button type="submit"
            className="w-full bg-[#1E3A2F] text-brand-primary hover:text-white border border-brand-primary/20 hover:bg-[#254639] transition-all rounded-xl md:rounded-2xl py-3 md:py-5 flex items-center justify-center font-black text-xs md:text-sm uppercase tracking-widest gap-2 shadow-lg hover:shadow-brand-primary/20">
