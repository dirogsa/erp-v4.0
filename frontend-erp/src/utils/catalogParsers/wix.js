...
const parseWixModern = (doc, domain, dbCategories = []) => {
    ...
    if (summaryEl) {
        ...
        // Regex: captura "Cualquier texto (LETRA) = VALOR mm" o "LETRA = VALOR mm"
    ...
    // Fuente Secundaria (Fallback): Tabla #dimensions — solo si el summary no dio resultados
    if (!specsFromSummary) {
