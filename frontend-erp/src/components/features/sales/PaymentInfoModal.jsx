        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ padding: '1.5rem' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'grid', gap: '0.75rem' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <span style={{ color: 'white' }}>{invoice.customer_name}</span>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    {/* Payment Terms */}
                    {invoice.payment_terms && invoice.payment_terms.type === 'CREDIT' &&
                        invoice.payment_terms.installments && invoice.payment_terms.installments.length > 0 && (
                            <div style={{
                                backgroundColor: '#1e293b',
                                borderRadius: '0.5rem',
                                padding: '1.5rem',
                                ...
                                <div style={{ overflowX: 'auto' }}>
                                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                        ...
                                        <tbody>
                                            {invoice.payment_terms.installments.map((inst, index) => (
                                                <tr key={index} style={{ borderBottom: '1px solid #334155' }}>
                                                    <td style={{ padding: '0.75rem', color: '#e2e8f0' }}>
                                                        #{inst.number || index + 1}
                                                    </td>
